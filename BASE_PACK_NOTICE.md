# bstrings installer component

This archive is an internal part of the Windows release.

Do not use this archive as a separate bstrings installation. It does not contain
all supported engines, models, licenses, or verification data.
