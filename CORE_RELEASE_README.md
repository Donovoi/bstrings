# bstrings v1.9.5 Windows x64 core

This self-contained core is the native scanner component of the complete
v1.9.5 release. It includes the managed application, native Rust engine,
...
[v1.9.5 quality installer](https://github.com/Donovoi/bstrings/blob/v1.9.5/README.md#get-started),
...
core command reference. Download details are in the
[online installation guide](https://github.com/Donovoi/bstrings/blob/v1.9.5/docs/download-and-install.md).
