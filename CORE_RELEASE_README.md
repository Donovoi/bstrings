# bstrings v1.9.6 Windows x64 core

This self-contained core is the native scanner component of the complete
v1.9.6 release. It includes the managed application, native Rust engine,
...
[v1.9.6 quality installer](https://github.com/Donovoi/bstrings/blob/v1.9.6/README.md#get-started),
...
[online installation guide](https://github.com/Donovoi/bstrings/blob/v1.9.6/docs/download-and-install.md).
