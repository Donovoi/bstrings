# bstrings v1.9.11 Windows x64 core

This self-contained core is the native scanner component of the complete
v1.9.11 release. It includes the managed application, native Rust engine,
...
[v1.9.11 quality installer](https://github.com/Donovoi/bstrings/blob/v1.9.11/README.md#get-started),
...
details are in the
[online installation guide](https://github.com/Donovoi/bstrings/blob/v1.9.11/docs/download-and-install.md).
