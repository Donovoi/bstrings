# bstrings v1.9.10 Windows x64 core

This self-contained core is the native scanner component of the complete
v1.9.10 release. It includes the managed application, native Rust engine,
...
[v1.9.10 quality installer](https://github.com/Donovoi/bstrings/blob/v1.9.10/README.md#get-started),
...
Run `.\bstrings.exe help` or `.\bstrings.exe help analyze` for the complete
...
details are in the
[online installation guide](https://github.com/Donovoi/bstrings/blob/v1.9.10/docs/download-and-install.md).
