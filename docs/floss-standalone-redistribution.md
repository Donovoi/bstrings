...
Distribution status: this reviewed FLOSS payload is included in the bstrings
kit. Do not copy it between versioned installations. Use the verified installer
