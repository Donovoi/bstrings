...
OCR is distributed in the complete v1.9.7 quality kit. The commands in this
...
In the v1.9.7 quality kit, `--full` enables OCR in automatic mode and asks the
...
`cpu`, `directml`, `hybrid`, or `cuda`; however, the v1.9.7 source profile
...
The v1.9.7 source profile uses
