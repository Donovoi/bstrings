...
Current publication status: v1.9.7 is the fully gated Windows x64
...
## v1.9.7 release process and asset set

The exact v1.9.7 project-version tag publishes the asset set below after every
...
The workflow uses [`releases/v1.9.7.md`](releases/v1.9.7.md) as the human
...
README bootstrap uses GitHub's exact-tag API for `v1.9.7`, rejects a draft or
...
The v1.9.7 release process uses
